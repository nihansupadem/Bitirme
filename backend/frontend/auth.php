...
<nav>
  <a class="nav-brand" href="index.php"><span>📈</span>OpTrade</a>
  <a class="nav-link" href="index.php">← Back to Analysis</a>
</nav>
...
async function submitAuth(e, type) {
    ...
    try {
        const res  = await fetch('api_auth.php', { method:'POST', body: new FormData(form) });
