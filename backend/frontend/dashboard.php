...
<nav>
  <a class="nav-brand" href="index.php">📈 OpTrade</a>
  <a class="nav-link"  href="index.php">Analysis</a>
  <a class="nav-link"  href="dashboard.php" style="color:#29B6F6;">Dashboard</a>
...
<div class="container">
  ...
  <div class="page-hdr">
    <div>
      <h1>📊 My Dashboard</h1>
      <p>Track BIST30 stocks and receive BUY/SELL email alerts automatically</p>
    </div>
  ...
  <!-- Cron info banner -->
  <div class="cron-bar">
    <p>💡 <strong>Auto-alerts:</strong> run <code>php cron_signals.php</code> from the backend
  ...
  <div class="empty-state">
    ...
    <p>Add a BIST30 stock above to start receiving AI signal alerts.</p>
  </div>
  <?php else: ?>
    ...
    <div class="stock-card" id="card-<?= $ticker ?>">
      <div class="card-top">
        <div style="display:flex;justify-content:space-between;align-items:flex-start">
          ...
          <a href="index.php?stock=<?= $ticker ?>" target="_blank"
...
async function apiTracked(params) {
    ...
    const r = await fetch('api_tracked.php', {method:'POST', body:fd});
    return r.json();
}
